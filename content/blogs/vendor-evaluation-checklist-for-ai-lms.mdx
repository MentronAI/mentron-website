...
The scores are aggregated across the 8 sections. A vendor with 130+ points (out of 150) is a strong candidate. A vendor with 100–130 points is a possible candidate with reservations. A vendor with <100 points is unlikely to be a defensible choice.
