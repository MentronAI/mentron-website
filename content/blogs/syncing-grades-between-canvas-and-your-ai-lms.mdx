***
title: "Syncing Grades Between Canvas and Your AI LMS"
date: "2026-03-30"
...
This guide breaks down exactly how **canvas grade sync** works, what the LTI 1.3 standard actually does under the hood, where things typically break, and how an **AI LMS gradebook** like Mentron connects with Canvas so instructors never have to copy-paste a score again. Whether you're an administrator at a university, an instructional designer in K-12, or a training lead in corporate L&D, this is the technical and practical clarity you've been looking for.

---

## Why Canvas Grade Sync Is Critical for Modern Institutions
...
When a student clicks an externally linked assignment inside Canvas, Canvas initiates an LTI 1.3 launch. This hands the student off to the external tool (in this case, your AI LMS) along with a signed JWT token carrying the student's identity and the assignment's resource link ID. [According to the Learnosity grade passback documentation](https://help.learnosity.com/hc/en-us/articles/360006469817-Using-Grade-Passback-with-Learnosity-and-an-LMS-Platform), once the student completes the assessment, the tool sends a score back as a normalized decimal value between **0.0 and 1.0**, which Canvas then converts into the assignment's full point value.

This process is called **grade passback (GPB)** — the external tool "passes back" the result to the originating LMS. [The Canvas/PowerSchool integration guide from Instructure](https://community.instructure.com/en/kb/articles/663657-instructor-faq-canvas-and-powerteacher-grade-passback) confirms that Canvas can further pass those grades downstream to a Student Information System (SIS), making it possible to have a single source of truth flowing from AI assessment → Canvas gradebook → SIS.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Adaptive learning paths post-assessment</td>
      <td>Not supported</td>
