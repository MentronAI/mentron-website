...
description: "How university faculty can use anonymized AI LMS data for learning analytics research — covering eth — covers lms learning analytics research in 2026."
author:
...
**Ready to use your AI LMS data for research?** [Schedule a Mentron demo](/institutional-demo) and bring your research question, your IRB contact, and your data access workflow — by the end of the call, we will walk through the data sources available and the data request process.
...
1. [American Psychological Association — research methods](https://www.apa.org/pubs/journals) — apa.org
2. [PubMed Central — learning science research](https://www.ncbi.nlm.nih.gov/pmc/) — ncbi.nlm.nih.gov
...
Mentron is built around lms learning analytics research workflows for institutions that have moved past feature shopping. [Schedule a demo](https://mentron.in/institutional-demo) to walk through your specific requirements and see how the platform handles your own course material, learner data, and integration stack.
